                ...
                <div className="navbar navbar-fixed-top">
                  <div className="navbar-inner">
                    <div className="main_menu leftmenu">
                      <a href="#" className="hideopen" onClick={this.toggleLeftMenu} tabIndex="-1" ><Glyphicon glyph="menu-hamburger" id="menu_toggle" tabIndex="-1" />Menu</a>

                    </div>
                    <div className="rightmenu">
                      <a href="#" className="utilities" onClick={this.toggleRightMenu} tabIndex="-1" >Utilities</a>
                    </div>
                    <TopNavComponent/>
                  </div>
                </div>
