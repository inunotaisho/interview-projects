...
class DialogComponent extends Component{
  ...
  toggle(){
    return this.show = this.props.show;
  }
            ...
            <Modal dialogClassName ="bmodal dialog" show={this.toggle} onHide={this.close}>
              <Modal.Body className ="modalBody">
                <div className="table modalPadding">
                  ...
                  <div className="row">
                    <input type ="button" className ="btnSearch" onClick={this.onConfirm} value={this.props.confirmText} />
                    {!this.props.hideCancel ? <input type ="button" value={this.props.cancelText} className ="btnCancel" onClick={this.close} /> : null}
                  </div>
                </div>
              </Modal.Body>
            </Modal>
