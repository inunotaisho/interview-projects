...
const applicationConfig = {
  apiServiceUrl: "http://localhost/RxNTMasterAPIServices/", //url for API service to be connected
  loginUrl: "http://localhost/adminv2/default.aspx#", //default login url
  clientVersion: "RXVER-123", //The version ket used to check if the ui and APIs are in sync
  hostedIP: "http://localhost/AdminV2/", //Host location for logging purpose
...
export default {
  ...
  module: {
    loaders: [
      {test: /\.js$/, include: [path.join(__dirname, 'src'), path.join(__dirname, 'data-store')], loaders: ['babel']},
