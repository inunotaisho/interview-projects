...
const applicationConfig = {
  apiServiceUrl: "http://devqa.rxnt.com/RxNTMasterAPIServices/", //url for API service to be connected
  loginUrl: "http://devqa.rxnt.com/adminv2/default.aspx#", //default login url
  clientVersion: "RXVER-123", //The version ket used to check if the ui and APIs are in sync
  hostedIP: "http://devqa.rxnt.com/AdminV2/", //Host location for logging purpose,
...
export default {
  ...
  module: {
    loaders: [
      ...
      {test: /\.(jpe?g|png|gif)$/i, loader: "url-loader?name=[path][name].[ext]"},
      {
        test: /(\.css|\.scss)$/,
