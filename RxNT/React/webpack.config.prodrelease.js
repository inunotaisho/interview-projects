...
const applicationConfig = {
  apiServiceUrl: "https://localhost/RxNTMasterAPIServices/", //url for API service to be connected
  loginUrl: "https://localhost/adminv2/default.aspx#", //default login url
  clientVersion: "RXVER-123", //The version ket used to check if the ui and APIs are in sync
  hostedIP: "https://localhost/AdminV2/", //Host location for logging purpose
