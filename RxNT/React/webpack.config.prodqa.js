...
const applicationConfig = {
  apiServiceUrl: "http://prodqa.rxnt.com/RxNTMasterAPIServices/", //url for API service to be connected
  loginUrl: "http://prodqa.rxnt.com/adminv2/default.aspx#", //default login url
  clientVersion: "RXVER-123", //The version ket used to check if the ui and APIs are in sync
  hostedIP: "http://prodqa.rxnt.com/AdminV2/", //Host location for logging purpose
